...
class _TranslationsMisskeyWatermarkEditorNlNl extends TranslationsMisskeyWatermarkEditorEnUs {
	_TranslationsMisskeyWatermarkEditorNlNl._(TranslationsNlNl root) : this._root = root, super.internal(root);
