...
// Path: misskey.qr_
class _TranslationsMisskeyQrUkUa extends TranslationsMisskeyQrEnUs {
	_TranslationsMisskeyQrUkUa._(TranslationsUkUa root) : this._root = root, super.internal(root);
