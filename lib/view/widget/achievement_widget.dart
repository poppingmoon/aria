    ...
    return switch (achievement) {
      'notes1' => Tooltip(
          richMessage: TextSpan(
            children: [
              TextSpan(
                text: t.misskey.achievements_.types_.notes1_.description,
              ),
              const TextSpan(text: '\n\n'),
              TextSpan(
      ...
      'login3' => Tooltip(
          richMessage: TextSpan(
            children: [
              TextSpan(
                text: t.misskey.achievements_.types_.login3_.description,
              ),
              const TextSpan(text: '\n\n'),
              TextSpan(
      ...
      'login7' => Tooltip(
          richMessage: TextSpan(
            children: [
              TextSpan(
                text: t.misskey.achievements_.types_.login7_.description,
              ),
              const TextSpan(text: '\n\n'),
              TextSpan(
      ...
      'postedAtLateNight' => Tooltip(
          richMessage: TextSpan(
            children: [
              TextSpan(
                text: t.misskey.achievements_.types_.postedAtLateNight_
                    .description,
              ),
              const TextSpan(text: '\n\n'),
              TextSpan(
      ...
      'postedAt0min0sec' => Tooltip(
          richMessage: TextSpan(
            children: [
              TextSpan(
                text: t
                    .misskey.achievements_.types_.postedAt0min0sec_.description,
              ),
              const TextSpan(text: '\n\n'),
              TextSpan(
      ...
      'viewInstanceChart' => Tooltip(
          message:
              t.misskey.achievements_.types_.viewInstanceChart_.description,
          child: Text(
            t.misskey.achievements_.types_.viewInstanceChart_.title,
          ),
        ),
      'outputHelloWorldOnScratchpad' => Tooltip(
          message: t.misskey.achievements_.types_.outputHelloWorldOnScratchpad_
              .description,
          child: Text(
      ...
      'driveFolderCircularReference' => Tooltip(
          message: t.misskey.achievements_.types_.driveFolderCircularReference_
              .description,
          child: Text(
      ...
      'passedSinceAccountCreated1' => Tooltip(
          message: t.misskey.achievements_.types_.passedSinceAccountCreated1_
              .description,
          child: Text(
      ...
      'passedSinceAccountCreated2' => Tooltip(
          message: t.misskey.achievements_.types_.passedSinceAccountCreated2_
              .description,
          child: Text(
      ...
      'passedSinceAccountCreated3' => Tooltip(
          message: t.misskey.achievements_.types_.passedSinceAccountCreated3_
              .description,
          child: Text(
      ...
      'loggedInOnBirthday' => Tooltip(
          message:
              t.misskey.achievements_.types_.loggedInOnBirthday_.description,
          child: Text(
      ...
      'loggedInOnNewYearsDay' => Tooltip(
          richMessage: TextSpan(
            children: [
              TextSpan(
                text: t.misskey.achievements_.types_.loggedInOnNewYearsDay_
                    .description,
              ),
              const TextSpan(text: '\n\n'),
              TextSpan(
                text: t
                    .misskey.achievements_.types_.loggedInOnNewYearsDay_.flavor,
                style: const TextStyle(fontStyle: FontStyle.italic),
              ),
            ],
          ),
      ...
      'smashTestNotificationButton' => Tooltip(
          message: t.misskey.achievements_.types_.smashTestNotificationButton_
              .description,
          child: Text(
      ...
      'tutorialCompleted' => Tooltip(
          message:
              t.misskey.achievements_.types_.tutorialCompleted_.description,
          child: Text(
