              ...
              user == null
                  ...
                  : ListView(
                    ...
                    children: [
                      ...
                      if ((i == null &&
                              (meta?.policies?.canSearchNotes ?? true)) ||
                          ...
                          ListTile(
                            ...
                            onTap: () async {
                              final comment = await showTextFieldDialog(
                                context,
                                title: Text(
                                  t.misskey.reportAbuseOf(name: user.acct),
                                ),
                                decoration: InputDecoration(
                                  helperText:
                                      t.misskey.fillAbuseReportDescription,
                                ),
                                maxLines: null,
                              );
                              if (!context.mounted) return;
