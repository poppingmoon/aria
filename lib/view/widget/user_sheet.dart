...
class UserSheet extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return DraggableScrollableSheet(
      ...
      maxChildSize: 0.8,
      expand: false,
      builder: (context, scrollController) => user == null
              ...
              children: [
                ...
                ListTile(
                  ...
                  onTap: () {
                    copyToClipboard(
                      context,
                      serverUrl.replace(pathSegments: [user.acct]).toString(),
                    );
                    context.pop();
                  },
                ),
                ...
                if (i != null &&
                  ...
                  ListTile(
                    ...
                    onTap: () => context.push('/$account/chat/user/$userId'),
                  ),
                  ...
                  ListTile(
                    ...
                    onTap: () async {
                      ...
                      if (destination.host == account.host) {
                        ...
                        if (userAsLocal != null) {
                          await context.push(
                            '/$destination/users/${userAsLocal.id}',
                          );
                        }
                      }
                    },
                ...
                if ((i == null && (meta?.policies?.canSearchNotes ?? true)) ||
                  ...
                  ListTile(
                    ...
                    onTap: () =>
                        context.push('/$account/search?userId=$userId'),
                  ),
                if (!account.isGuest) ...[
                  ListTile(
                    ...
                    if (user.isMuted)
                      ...
                      ListTile(
                        ...
                        onTap: () => showDialog<void>(
                          context: context,
                          builder: (context) =>
                              MuteDialog(account: account, userId: userId),
                        ),
                      ),
