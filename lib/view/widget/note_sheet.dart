            ...
            children: [
              ListTile(
                leading: UserAvatar(
                  ...
                  onTap:
                      () =>
                          context.push('/$account/users/${appearNote.userId}'),
                ),
                ...
                ListTile(
                  ...
                  onTap: () async {
                    ...
                    if (destination.host == account.host) {
                      await context.push(
                        '/$destination/notes/${appearNote.id}',
                      );
                      return;
                    }
              ...
              ListTile(
                ...
                onTap:
                    () => context.push(
                      '/$account/notes/${appearNote.id}/after-renotes',
                    ),
              ),
              if (!account.isGuest) ...[
                ...
                if (appearNote.user.host == null &&
                  ...
                  if (canEditNote)
                    ListTile(
                      ...
                      onTap:
                          () => context.push(
                            '/$account/notes/${appearNote.id}/edit',
                          ),
                    ),
                  ListTile(
