...
class NoteDisplayPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fontSize = useState(
      clampDouble(settings.fontSize, minFontSize, maxFontSize),
    );
    final lineHeight = useState(
      clampDouble(settings.lineHeight, minLineHeight, maxLineHeight),
    );
    final avatarScale = useState(
      clampDouble(settings.avatarScale, minAvatarScale, maxAvatarScale),
    );
    ...
    final noteVerticalPadding = useState(
      clampDouble(settings.noteVerticalPadding, 0.0, maxNoteVerticalPadding),
    );
    ...
    return GeneralSettingsScaffold(
      ...
      body: MultiSplitViewTheme(
        ...
        child: MultiSplitView(
          ...
          builder:
              (context, area) => switch (area.data as _NoteDisplayArea) {
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(switch (settings
                              .mediaListWithOneImageAppearance) {
                            null => t.misskey.default_,
                            MediaListWithOneImageAppearance.r16_9 => t.misskey
                                .limitTo(x: '16:9'),
                            MediaListWithOneImageAppearance.r1_1 => t.misskey
                                .limitTo(x: '1:1'),
                            MediaListWithOneImageAppearance.r2_3 => t.misskey
                                .limitTo(x: '2:3'),
                          }),
                          trailing: const Icon(Icons.navigate_next),
                          onTap: () async {
                            final result = await showRadioDialog(
                              ...
                              itemBuilder:
                                  (context, value) => Text(switch (value.$1) {
                                    null => t.misskey.default_,
                                    MediaListWithOneImageAppearance.r16_9 => t
                                        .misskey
                                        .limitTo(x: '16:9'),
                                    MediaListWithOneImageAppearance.r1_1 => t
                                        .misskey
                                        .limitTo(x: '1:1'),
                                    MediaListWithOneImageAppearance.r2_3 => t
                                        .misskey
                                        .limitTo(x: '2:3'),
                                  }),
                            );
                            if (result != null) {
                              await ref
                                  ...
                                  .setMediaListWithOneImageAppearance(
                                    result.$1,
                                  );
                            }
                          },
                    ...
                    Center(
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Text(
                            settings.fontFamily ?? t.misskey.system,
                          ),
                          trailing: const Icon(Icons.navigate_next),
                          onTap: () async {
                            final result = await showRadioDialog(
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Slider(
                            ...
                            label: reactionsDisplayScale.value.toStringAsFixed(
                              3,
                            ),
                            onChanged:
                                (value) => reactionsDisplayScale.value = value,
                            onChangeEnd:
                                (value) => ref
                                    .read(
                                      generalSettingsNotifierProvider.notifier,
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Slider(
                            ...
                            onChanged:
                                (value) => noteVerticalPadding.value = value,
                            onChangeEnd:
                                (value) => ref
                                    .read(
                                      generalSettingsNotifierProvider.notifier,
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          ...
                          subtitle: Slider(
                            ...
                            label: noteHorizontalPadding.value.toStringAsFixed(
                              1,
                            ),
                            onChanged:
                                (value) => noteHorizontalPadding.value = value,
                            onChangeEnd:
                                (value) => ref
                                    .read(
                                      generalSettingsNotifierProvider.notifier,
