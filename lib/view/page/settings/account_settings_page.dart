      ...
      body: ListView(
        children: [
          ListTile(
            ...
            onTap: () => context.push('/settings/accounts/$account/profile'),
          ),
          ListTile(
            leading: const Icon(Icons.lock),
            title: Text(t.misskey.privacy),
            onTap: () => context.push('/settings/accounts/$account/privacy'),
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () => context.push('/settings/accounts/$account/mute-block'),
          ),
          ListTile(
