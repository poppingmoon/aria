                        ...
                        Card(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              if (request
                                  case NotesCreateRequest(:final replyId?))
                                InkWell(
                                  onTap: () => context
                                      .push('/${account.value}/notes/$replyId'),
                                  child: Row(
                                    children: [
                                      IconButton(
                                        onPressed: () => ref
                              ...
                              if (request
                                  case NotesCreateRequest(:final renoteId?))
                                InkWell(
                                  onTap: () => context.push(
                              ...
                              if (request
                                  case NotesCreateRequest(:final channelId?))
                                InkWell(
                                  onTap: () => context.push(
                                      ...
                                      ...visibleUsers.value.map(
                                        (user) => MentionWidget(
                                          ...
                                          onDeleted: () {
                                            ...
                                            visibleUsers.value = visibleUsers
                                                .value
                                ...
                                Padding(
                                  ...
                                  child: Shortcuts(
                                    ...
                                    child: TextField(
                                      ...
                                      maxLength: (request.cw?.length ?? 0) > 80
                                          ? 100
                                          : null,
                              ...
                              if (attaches.isNotEmpty) ...[
                                ...
                                Padding(
                                  ...
                                  child:
                                      PostFormAttaches(account: account.value),
                                ),
                              ],
