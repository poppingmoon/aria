...
_AccountSettings _$AccountSettingsFromJson(
  ...
  defaultNoteVisibility:
      $enumDecodeNullable(
        ...
        json['defaultNoteVisibility'],
      ) ??
      NoteVisibility.public,
  defaultNoteLocalOnly: json['defaultNoteLocalOnly'] as bool? ?? false,
  rememberRenoteVisibility: json['rememberRenoteVisibility'] as bool? ?? false,
  defaultRenoteVisibility:
      $enumDecodeNullable(
        _$NoteVisibilityEnumMap,
        json['defaultRenoteVisibility'],
      ) ??
      NoteVisibility.public,
  ...
  renoteVisibility:
      $enumDecodeNullable(_$NoteVisibilityEnumMap, json['renoteVisibility']) ??
      NoteVisibility.public,
  ...
  pinnedEmojisForReaction:
      ...
      defaultPinnedEmojis,
  pinnedEmojis:
      (json['pinnedEmojis'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      defaultPinnedEmojis,
  recentlyUsedEmojis:
      (json['recentlyUsedEmojis'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  ...
  hardMutedWords:
      ...
      const [],
  mutedEmojis:
      (json['mutedEmojis'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  recentlyUsedUsers:
      (json['recentlyUsedUsers'] as List<dynamic>?)
          ?.map((e) => e as String)
          .toList() ??
      const [],
  hashtags:
