...
mixin _$TabSettings {
 ...
 String? get id; TabType get tabType; String? get name; Account get account; TabIcon? get icon; bool get disableStreaming; bool get disableSubscribing; bool get withReplies; bool get withRenotes; bool get withSelfRenotes; bool get withFiles; bool get withSensitive; bool get keepPosition; String? get roleId; String? get channelId; String? get listId; String? get antennaId; String? get userId; String? get endpoint; String? get streamingChannel; Map<String, dynamic>? get parameters;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tabType,name,account,icon,disableStreaming,disableSubscribing,withReplies,withRenotes,withSelfRenotes,withFiles,withSensitive,keepPosition,roleId,channelId,listId,antennaId,userId,endpoint,streamingChannel,const DeepCollectionEquality().hash(parameters)]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,tabType,name,account,icon,disableStreaming,disableSubscribing,withReplies,withRenotes,withSelfRenotes,withFiles,withSensitive,keepPosition,roleId,channelId,listId,antennaId,userId,endpoint,streamingChannel,const DeepCollectionEquality().hash(_parameters)]);
